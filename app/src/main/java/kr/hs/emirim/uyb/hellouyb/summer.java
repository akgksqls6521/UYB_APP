...
public class summer extends AppCompatActivity {
    ...
    int[] top={R.drawable.summer_up1,R.drawable.summer_up2,R.drawable.summer_up3,R.drawable.summer_up4,R.drawable.summer_up5,R.drawable.summer_up6,R.drawable.summer_up7,R.drawable.summer_up8,0};
int[] pants={R.drawable.summer_down1,R.drawable.summer_down2,R.drawable.summer_down3,R.drawable.summer_down4,R.drawable.summer_down5,R.drawable.summer_down6,R.drawable.summer_down7,R.drawable.summer_down8,0};
        MyGalleryAdapter adapter = new MyGalleryAdapter(this);
@Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
    top_gallery[0]=R.drawable.summer_up1_gallery;
    top_gallery[1]=R.drawable.summer_up2_gallery;
    top_gallery[2]=R.drawable.summer_up3_gallery;
    top_gallery[3]=R.drawable.summer_up4_gallery;
    top_gallery[4]=R.drawable.summer_up5_gallery;
    top_gallery[5]=R.drawable.summer_up6_gallery;
    top_gallery[6]=R.drawable.summer_up7_gallery;
    top_gallery[7]=R.drawable.summer_up8_gallery;
    pants_gallery[0]=R.drawable.summer_down1_gallery;
    pants_gallery[1]=R.drawable.summer_down2_gallery;
    pants_gallery[2]=R.drawable.summer_down3_gallery;
    pants_gallery[3]=R.drawable.summer_down4_gallery;
    pants_gallery[4]=R.drawable.summer_down5_gallery;
    pants_gallery[5]=R.drawable.summer_down6_gallery;
    pants_gallery[6]=R.drawable.summer_down7_gallery;
    pants_gallery[7]=R.drawable.summer_down8_gallery;
    ...
    button1.setOnClickListener(new View.OnClickListener() {
        public void onClick(View v) {
            ...
            intent = new Intent(summer.this,success.class);
            intent.putExtra("bg",R.drawable.summersbg);
    ...
    back.setOnClickListener(new View.OnClickListener() {//이벤트 처리자!-익명클래스를 사용해 핸들러 구현
            @Override
            public void onClick(View v) {
                selected[0]=R.drawable.summer_up1;
                selected[1]=R.drawable.summer_up2;
                selected[2]=R.drawable.summer_up3;
                selected[3]=R.drawable.summer_up4;
                selected[4]=R.drawable.summer_up5;
                selected[5]=R.drawable.summer_up6;
                selected[6]=R.drawable.summer_up7;
                selected[7]=R.drawable.summer_up8;
                if(topposition==0)
                ...
                if(gotop==R.drawable.summer_up5){
                    imvDown.setImageResource(0);
        ...
        downback.setOnClickListener(new View.OnClickListener() {//이벤트 처리자!-익명클래스를 사용해 핸들러 구현
            @Override
            public void onClick(View v) {
                selected[0]=R.drawable.summer_down1;
                selected[1]=R.drawable.summer_down2;
                selected[2]=R.drawable.summer_down3;
                selected[3]=R.drawable.summer_down4;
                selected[4]=R.drawable.summer_down5;
                selected[5]=R.drawable.summer_down6;
                selected[6]=R.drawable.summer_down7;
                selected[7]=R.drawable.summer_down8;
                adapter.notifyDataSetChanged();
                if(gotop==R.drawable.summer_up5){
                    imvDown.setImageResource(0);
                    godown=0;
    ...
    public class MyGalleryAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(selected[0]==R.drawable.summer_down1) {
            ...
            imgV.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    if(selected[0]==R.drawable.summer_up1) {
